...
if __name__=='__main__':
    myMaze=maze(25,25)
    myMaze.CreateMaze(22,15,loopPercent=100)
    # myMaze.CreateMaze(loadMaze='dijkMaze.csv')

    h1=agent(myMaze,20,21,color=COLOR.red)
    h2=agent(myMaze,6,4,color=COLOR.red)
    h3=agent(myMaze,12,15,color=COLOR.red)
    h4=agent(myMaze,10,10,color=COLOR.red)
    h5=agent(myMaze,22,12,color=COLOR.red)
    ...
    path,c=dijkstra(myMaze,h2,h3,h4,start=(1,1))
